# Plugins1/FinalMusic/fm_plugins/playback-controls/skip.py
...
@Client.on_message(filters.group & ~filters.bot, group=515)
async def skip_handler(client, m: Message):
    ...
    try:
        ...
        try:
            sent_msg = await m.reply(_lang.get("play_skipped", "تم التخطي").format(m.from_user.mention))
        except:
